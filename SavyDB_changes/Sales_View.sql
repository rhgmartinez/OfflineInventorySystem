...
/****** Object:  View [dbo].[Sales]    Script Date: 8/26/2019 1:53:00 PM ******/
DROP VIEW [dbo].[Sales]
GO
...
FROM            dbo.Transactions INNER JOIN
                         ...
                         dbo.Payment ON dbo.Transactions.transactionId = dbo.Payment.transactionId CROSS JOIN
                         dbo.Brands CROSS JOIN
                         dbo.Products
