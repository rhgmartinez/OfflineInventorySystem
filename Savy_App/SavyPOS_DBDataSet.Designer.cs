...
SELECT paymentId, transactionId, totalAmount, amountPaid, change, CREATE_DATE, LAST_UPDATE_DATE FROM Payment WHERE (paymentId = @paymentId)";
    ...
    public partial class TransactionProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TransactionProducts] ([productId], [discount], [isPercent], [originalPrice], [discountedPrice], [quantity], [transactionId], [isReturned], [CREATE_DATE], [LAST_UPDATE_DATE]) VALUES (@productId, @discount, @isPercent, @originalPrice, @discountedPrice, @quantity, @transactionId, @isReturned, @CREATE_DATE, @LAST_UPDATE_DATE);
SELECT transProdId, productId, discount, isPercent, originalPrice, discountedPrice, quantity, transactionId, isReturned, CREATE_DATE, LAST_UPDATE_DATE FROM TransactionProducts WHERE (transProdId = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[TransactionProducts] SET [productId] = @productId, [discount] = @di" +
                ...
                "Id, [isReturned] = @isReturned, [CREATE_DATE] = @CREATE_DATE, [LAST_UPDATE_DATE]" +
                " = @LAST_UPDATE_DATE WHERE (([transProdId] = @Original_transProdId) AND ((@IsNul" +
                ...
                " @Original_isPercent)) AND ((@IsNull_originalPrice = 1 AND [originalPrice] IS NU" +
                "LL) OR ([originalPrice] = @Original_originalPrice)) AND ((@IsNull_discountedPric" +
                "e = 1 AND [discountedPrice] IS NULL) OR ([discountedPrice] = @Original_discounte" +
                "dPrice)) AND ((@IsNull_quantity = 1 AND [quantity] IS NULL) OR ([quantity] = @Or" +
                "iginal_quantity)) AND ((@IsNull_transactionId = 1 AND [transactionId] IS NULL) O" +
                "R ([transactionId] = @Original_transactionId)) AND ((@IsNull_isReturned = 1 AND " +
                "[isReturned] IS NULL) OR ([isReturned] = @Original_isReturned)) AND ((@IsNull_CR" +
                "EATE_DATE = 1 AND [CREATE_DATE] IS NULL) OR ([CREATE_DATE] = @Original_CREATE_DA" +
                "TE)) AND ((@IsNull_LAST_UPDATE_DATE = 1 AND [LAST_UPDATE_DATE] IS NULL) OR ([LAS" +
                "T_UPDATE_DATE] = @Original_LAST_UPDATE_DATE)));\r\nSELECT transProdId, productId, " +
                "discount, isPercent, originalPrice, discountedPrice, quantity, transactionId, is" +
                "Returned, CREATE_DATE, LAST_UPDATE_DATE FROM TransactionProducts WHERE (transPro" +
                "dId = @transProdId)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT transProdId, productId, discount, isPercent, originalPrice, discountedPric" +
                "e, quantity, transactionId, isReturned, CREATE_DATE, LAST_UPDATE_DATE FROM dbo.T" +
                "ransactionProducts";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Update(
                    ...
                    string Original_CREATE_DATE, 
                    string Original_LAST_UPDATE_DATE) {
            return this.Update(productId, discount, isPercent, originalPrice, discountedPrice, quantity, transactionId, isReturned, CREATE_DATE, LAST_UPDATE_DATE, Original_transProdId, Original_productId, Original_discount, Original_isPercent, Original_originalPrice, Original_discountedPrice, Original_quantity, Original_transactionId, Original_isReturned, Original_CREATE_DATE, Original_LAST_UPDATE_DATE, Original_transProdId);
        }
    }
